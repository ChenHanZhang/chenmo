...
#include "chenmo/net/TcpConnection.h"

#include "chenmo/base/Logging.h"
#include "chenmo/base/WeakCallback.h"
...
void chenmo::net::defaultConnectionCallback(const TcpConnectionPtr& conn)
{
...
void chenmo::net::defaultMessageCallback(const TcpConnectionPtr&,
                                        Buffer* buf,
                                        Timestamp)
{
  buf->retrieveAll();
